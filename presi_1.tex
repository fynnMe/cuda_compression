...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Turing Architektur → maximal 16 Thread-Blocks pro SM.
              Ist $72 \cdot 16 = 1152$ maximale Anazahl rechnender Blöcke
              auf ganzer GPU zu einem Zeitpunk?
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    ...
    Daten auf dem Bus zwische Host und GPU, wenn bit-gepackt ub uin16
    \begin{lstlisting}
